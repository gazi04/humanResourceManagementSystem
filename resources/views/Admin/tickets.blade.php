								...
								<table class="table table-striped custom-table mb-0 datatable">
									...
									<tbody>
										<tr>
											...
											<td>
												<h2 class="table-avatar">
													<a class="avatar avatar-xs" href="profile.html"><img alt="{{ asset('') }}" src="assets/img/profiles/avatar-10.jpg"></a>
													<a href="#">John Smith</a>
												</h2>
											</td>
										...
										<tr>
											...
											<td>
												<h2 class="table-avatar">
													<a class="avatar avatar-xs" href="profile.html"><img src="{{ asset('assets/img/profiles/avatar-08.jpg') }}"></a>
											...
											<div class="form-group">
												...
												<div class="project-members">
													...
													<a title="Wilmer Deluna" data-toggle="tooltip" href="#" class="avatar">
														<img src="{{ asset('assets/img/profiles/avatar-11.jpg') }}" alt="">
													</a>
