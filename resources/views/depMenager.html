          ...
          <div id="sidebar-menu" class="sidebar-menu">
            ...
            <li>
              <a href="settings.html"
                ><i class="la la-ticket"></i> <span>Settings</span></a
              >
            </li>
          </div>
        </div>
        ...
        <div class="content container-fluid">
          ...
          <div class="page-header">
            <div class="row align-items-center">
              <div class="col">
                <h3 class="page-title">Menaxheri i Departamenteve</h3>
                <ul class="breadcrumb">
                  <li class="breadcrumb-item">
                    <a href="index.html">Dashboard</a>
                  </li>
                  <li class="breadcrumb-item active">Menaxheri</li>
                </ul>
              </div>
              <div class="col-auto float-right ml-auto">
                <a
                  ...
                  ><i class="fa fa-plus"></i> Shto Puntorin</a
                >
              </div>
            </div>
          </div>
          ...
          <div class="row filter-row">
            <div class="col-sm-6 col-md-3">
              <div class="form-group form-focus">
                ...
                <label class="focus-label">ID e Puntorit</label>
              </div>
            </div>
            <div class="col-sm-6 col-md-3">
              <div class="form-group form-focus">
                <input type="text" class="form-control floating" />
                <label class="focus-label">Emri i Puntorit</label>
              </div>
            </div>

            <div class="col-sm-6 col-md-3">
              <a href="#" class="btn btn-success btn-block"> Kerko</a>
            </div>
          </div>
          <!-- /Search Filter -->
          ...
          >
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Shto Puntorin</h5>
                <button
                  type="button"
                  class="close"
                  data-dismiss="modal"
